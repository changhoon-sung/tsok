...
tsok is released under [CC0 1.0](LICENSE). Third-party components retain their
respective licenses. Run `tsok licenses` to locate the dependency report for
the exact commit used to build the CLI.
